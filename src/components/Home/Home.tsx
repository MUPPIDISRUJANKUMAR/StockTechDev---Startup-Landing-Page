...
const Home = () => {
  return (
    <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center flex items-center justify-center">
      <div className="w-[90%] md:w-[80%] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-10 items-center">
        ...
        <div data-aos="fade-up">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 leading-[2.5rem] md:leading-[3.5rem]">
            ...
            <span className="text-rose-700">StockTechDev</span>
          </h1>
          <p className="text-xm sm:text-sm md:text-base font-medium text-gray-700">
            StockDevTools helps you analyze stocks smarter and predict market
            trends with ease. Our goal is simple: make powerful analysis tools
            accessible to everyone, so you can trade and invest with confidence.
          </p>
